        ...
        <div className="row">
          <div className="col">
            ...
            <div className="mb-5">
              ...
              <div class="border-left-pink col-sm-8">
              ...
              <div className="row">
                ...
                <div className="col-sm-4">
                  <input type="string" name="email" className="col-sm-6 form-control" id="email" value={user && user.email} onChange={this.handleChange} placeholder='Email' />
                </div>
                <div className="col">
