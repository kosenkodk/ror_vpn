...
import SecurityImageSrc from 'images/bg_security_and_trust2'
import SecurityCometsSrc from 'images/bg_security_and_trust2_comets'
      ...
      <div id="security_and_trust" className="row card d-flex flex-column">
        <div className="row no-gutters d-flex align-items-center">
          <div className="col-md-4">
            <img src={SecurityImageSrc} className="img-fluid" />
          </div>
          <div className="col-md-4">
          ...
          <div className="col-md-4">
            <img src={SecurityCometsSrc} className="img-fluid" />
          </div>
          <div className="col-md-4">
