        ...
        <div className="modal-body">
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-6">
              <textarea type="text" id="invoice_details" name="invoice_details" className="form-control" value={this.state.invoice_details || ''} onChange={this.handleChange} required={false}
