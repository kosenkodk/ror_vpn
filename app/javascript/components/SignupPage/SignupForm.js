      ...
      <React.Fragment>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-6">
            <input type="email" onChange={this.props.onEmailChange} value={this.props.email} required={true} className="form-control" placeholder={I18n.t('pages.login.form.help.email')} />
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-6">
            <input type="password" onChange={this.props.onPasswordChange} value={this.props.password} required={false} className="form-control" placeholder={I18n.t('pages.login.form.help.password')} />
