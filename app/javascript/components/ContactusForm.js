      ...
      <form>
        <div className="form-group row">
          ...
          <div className="col-sm-8">
            <input type="email" name="contact[email]" required={true} className="form-control" ref={(input) => { this.email = input }} placeholder={I18n.t('pages.contact_us.form.help.email')} />
          </div>
        </div>
        <div className="form-group row">
