  ...
  render() {
    return (
      <ul className="sidebar list-group shadow-vega bg-vega mb-4">
        ...
        <li className="list-group-item"><Link to={Routes.coming_soon.path}>Dashboard</Link></li>
        <li className="list-group-item"><Link to={Routes.coming_soon.path}>Account</Link></li>
        <li className="list-group-item"><Link to={Routes.tickets.path}>{Routes.tickets.name}</Link></li>
        <li className="list-group-item"><Link to={Routes.coming_soon.path}>Payment</Link></li>
        <li className="list-group-item"><Link to={Routes.coming_soon.path}>Downloads</Link></li>
        <li className="list-group-item"><Link to={Routes.coming_soon.path}>Refer Friends</Link></li>
